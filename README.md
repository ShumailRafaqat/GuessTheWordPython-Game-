This is a simple Python word guessing game where players try to guess a hidden word by suggesting letters.

Files
index.py: The main script for running the game.
How to Run
